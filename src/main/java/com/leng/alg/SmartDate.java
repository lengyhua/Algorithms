...
import com.bedpotato.alg4.Date;
...
public class SmartDate{
   ...
   /**
     ...
     */
    public boolean isAfter(SmartDate b) {
     ...
     */
    public boolean isBefore(SmartDate b) {
        return compareTo(b) < 0;
    }
    ...
    public static void main(String[] args) {
        SmartDate sd = new SmartDate("2/29/2016");
        SmartDate af = sd.next();
